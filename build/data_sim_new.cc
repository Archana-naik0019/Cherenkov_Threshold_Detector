void OverlayWithRatio() {
    ...
    double shubhi4[Nshubhi4]= {9.70,11.27,15.08,23.04,24.79,28.00,28.43,32.58,35.11,41.68,40.76,46.05,44.48,45.95}; //shubhi 3.5
    ...
    gData->SetTitle("Shubhi 4PE vs JGS2 Simulation;Pressure (atm);Efficiency (%)");
    ...
    legend->AddEntry(gData,"Shubhi Analysis (3.5 PE)","lep");
    ...
    c1->SaveAs("Shubhi3.5PE_vs_JGS2_Ratio.pdf");
}
